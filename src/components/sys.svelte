                        ...
                        <td>
                            <div class="bar-wrap">
                                <div
                                    ...
                                    class:warn={cpuStore.stats
                                        .cpu_usage_percent > 70}
                                    class:danger={cpuStore.stats
                                ...
                                <span
                                    ...
                                    class:danger={cpuStore.stats
                                        .cpu_usage_percent > 90}
                                >
                                    {cpuStore.stats.cpu_usage_percent.toFixed(
                                        1,
                                    )}%
                                </span>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bar-wrap">
                                ...
                                ></div>
                                <span
                                    >{cpuStore.stats.ram_used_mb} / {cpuStore
                                        .stats.ram_total_mb}</span
                                >
                            </div>
                        </td>
                                ...
                                <div class="bar-wrap">
                                    ...
                                    <span
                                        ...
                                        class:danger={cpuStore.stats
                                            .cpu_temp_celsius > 95}
                                    >
                                        {cpuStore.stats.cpu_temp_celsius.toFixed(
                                            1,
                                        )}
                                    </span>
                                </div>
